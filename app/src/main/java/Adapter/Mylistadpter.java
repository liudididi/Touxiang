...
public class Mylistadpter extends RecyclerView.Adapter<Mylistadpter.viewholder> {
    ...
    public Mylistadpter(Context context, List<Shangpin> list) {
    ...
    public viewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.list_a, null);
