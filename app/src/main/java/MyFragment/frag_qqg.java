...
public class frag_qqg extends Fragment {
    ...
    private void initdata() {
        Okhttputils.requer("http://120.27.23.105/product/getProductCatagory?cid=2", new Okhttputils.Backquer() {
            @Override
    ...
    private void initview() {
        ...
        ImageLoader.getInstance().displayImage("https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1005432978,3101158197&fm=200&gp=0.jpg",img_fltitle);
