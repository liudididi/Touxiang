...
public class frag_nvz extends Fragment {
    ...
    private void initdata() {
        Okhttputils.requer("http://120.27.23.105/product/getProductCatagory?cid=5", new Okhttputils.Backquer() {
            @Override
    ...
    private void initview() {
        ...
        ImageLoader.getInstance().displayImage("https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1322143337,1589118995&fm=27&gp=0.jpg",img_fltitle);
