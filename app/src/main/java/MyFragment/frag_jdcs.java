...
public class frag_jdcs extends Fragment {
    ...
    private void initdata() {
        Okhttputils.requer("http://120.27.23.105/product/getProductCatagory?cid=1", new Okhttputils.Backquer() {
            @Override
                    ...
                    if(list1!=null&&list2!=null&&list3!=null&&list4!=null){
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                my.setOnrecyclik(new Myflcycle.Onflrecyclik() {
                                    @Override
                                    public void MyreclOnk(ImageView img, int postion) {
                                        Intent in=new Intent(getActivity(), Sousuo.class);
                                        in.putExtra("guanjian",list1.get(postion).name);
                                        startActivity(in);
                                    }
                                });
                                ...
                                my2.setOnrecyclik(new Myflcycle.Onflrecyclik() {
                                    @Override
                                    public void MyreclOnk(ImageView img, int postion) {
                                        Intent in=new Intent(getActivity(), Sousuo.class);
                                        in.putExtra("guanjian",list2.get(postion).name);
                                        startActivity(in);
                                    }
                                });
                                ...
                                my3.setOnrecyclik(new Myflcycle.Onflrecyclik() {
                                    @Override
                                    public void MyreclOnk(ImageView img, int postion) {
                                        Intent in=new Intent(getActivity(), Sousuo.class);
                                        in.putExtra("guanjian",list3.get(postion).name);
                                        startActivity(in);
                                    }
                                });
                                ...
                                my4.setOnrecyclik(new Myflcycle.Onflrecyclik() {
                                    @Override
                                    public void MyreclOnk(ImageView img, int postion) {
                                        Intent in=new Intent(getActivity(), Sousuo.class);
                                        in.putExtra("guanjian",list4.get(postion).name);
                                        startActivity(in);
                                    }
                                });
