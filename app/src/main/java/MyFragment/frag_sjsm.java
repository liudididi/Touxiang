...
public class frag_sjsm extends Fragment {
    ...
    private void initdata() {
        Okhttputils.requer("http://120.27.23.105/product/getProductCatagory?cid=3", new Okhttputils.Backquer() {
            @Override
    ...
    private void initview() {
        ...
        ImageLoader.getInstance().displayImage("https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3378982026,2010088487&fm=200&gp=0.jpg",img_fltitle);
